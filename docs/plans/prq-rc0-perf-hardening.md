# PRQ-RC0: Performance Hardening

**Status:** queued (fleshed out when prior milestone gate passes)

**Blocked by:** PRQ-B9 (beta gate).

## Goal

Instancing audit per archetype, GLB lazy-load per floor, KTX2 audit. Mobile target ≥50 fps iPhone 12 / ≥30 fps iPhone SE 2.

## Spec reference

`docs/superpowers/specs/2026-04-29-dord-foundation-design.md` §22.3.
